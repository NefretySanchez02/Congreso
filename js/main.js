(function ($) {
    ...
    _this
      ...
      .on("update.countdown", function (event) {
        _this.html(
          event.strftime(
            "" +
              '<div class="countdown-container"><div class="countdown-box first"><div class="number">%-D</div><span>Días</span></div>' +
              '<div class="countdown-box"><div class="number">%H</div><span>Horas</span></div>' +
              '<div class="countdown-box"><div class="number">%M</div><span>Minutos</span></div>'
          )
        );
      });
  });
  ...
  $(".c-schedule .c-schedule__btn").on("click", function (e) {
    var lastItem = $(".c-schedule .c-schedule__btn-content").prev();
    if (lastItem.hasClass("border-color-transparent")) {
      lastItem.removeClass("border-color-transparent");
    }
    $(this).remove();
    $(
      ".c-schedule .c-schedule__tab .tab-content #monday .time-table .panel"
    ).each(function () {
      if ($(this).hasClass("c-schedule__panel--hide")) {
        $(this).removeClass("c-schedule__panel--hide");
      }
    });
  });
})(jQuery);
